  ...
  return (
    <div className="integration-card surface-card card-hover">
      <div className="integration-head">
        ...
        {status.configured && <span className="status status-active">connected</span>}
      </div>
      ...
      <p className="muted" style={{ margin: "8px 0 0" }}>
        ⚠️ Your WhatsApp number is converted to the Business Platform API — it can no longer be used in the regular app
